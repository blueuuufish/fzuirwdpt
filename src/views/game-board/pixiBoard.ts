...
import { PuzzlePieceSprite } from './PuzzelePieceSprite'
  ...
  return {
    pixiContainer,pixiApp,pixiViewport,pieceContainer,puzzlePieces,pieceMap,worldWidth,worldHeight,puzzleTexture,puzzle,activePuzzlePiece,
    reset,setWorldSize,createPieces,setGroup,onDragMove
  }
}